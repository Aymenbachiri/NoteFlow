...
export default function SinglePostItemSkeleton() {
  return (
    <View className="flex-1 animate-pulse h-screen relative mx-auto dark:bg-gray-900">
      <View className="animate-pulse rounded bg-white dark:bg-gray-800 shadow-md transition-shadow duration-300">
        {/* Skeleton for Image Section */}
        <View className="h-[500px] w-full rounded animate-pulse bg-gray-200 dark:bg-gray-700" />
